...
bool importMesh(const std::string &filePath, Mesh &mesh, const bool calcNormals = false);
bool importMeshes(const std::string &filePath, std::vector<Mesh> &meshes, const bool calcNormals = false);
